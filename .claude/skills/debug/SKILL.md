---
name: debug
description: Systematic debugging process. Find root cause before attempting fixes. Four phases — investigate, analyze patterns, test hypothesis, implement fix. No guessing.
...
4. If >= 3: **STOP and question the architecture** (see below)
5. DON'T attempt Fix #4 without architectural discussion
