...
return static function (ContainerConfigurator $configurator) {
    ...
    $services->set('neusta_pimcore_http_cache.element.dependent_element_invalidator', DependentElementInvalidator::class)
    ...
    $services->set('neusta_pimcore_http_cache.element.invalidate_listener', InvalidateElementListener::class)
        ...
        ->arg('$dispatcher', service('event_dispatcher'))
        ->arg('$dependentElementInvalidator', service('neusta_pimcore_http_cache.element.dependent_element_invalidator'));
